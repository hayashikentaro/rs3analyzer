...
/* ロマンシング サ・ガ3の文字コード表(メッセージ用・マルチバイト2バイト目) */
const getMb2Char = (index) => {
    return [
        /* 0x20 */
        " ",  "あ", "い", "う", "え", "お", "か", "き", "く", "け", "こ", "さ", "し", "す", "せ", "そ",
        "た", "ち", "っ", "て", "と", "な", "に", "ぬ", "ね", "の", "は", "ひ", "ふ", "ほ", "ま", "み",
        "む", "め", "も", "や", "ゆ", "よ", "ら", "り", "る", "れ", "ろ", "わ", "を", "ん", "ゃ", "ゅ",
        "ょ", "っ", "ア", "イ", "ウ", "エ", "オ", "カ", "キ", "ク", "ケ", "コ", "サ", "シ", "ス", "セ",
        "ソ", "タ", "チ", "ツ", "テ", "ト", "ナ", "ニ", "ヌ", "ネ", "ノ", "ハ", "ヒ", "フ", "ヘ", "ホ",
        "マ", "ミ", "ム", "メ", "モ", "ヤ", "ユ", "ヨ", "ラ", "リ", "ル", "レ", "ロ", "ワ", "ン", "ァ",
        ...
        "羅", "刹", "屍", "閃", "双", "車", "勁", "烈", "臨", "螢", "縛", "順", "歳", "殊", "設", "各",
...
(async () => {
    for await (const chunk of process.stdin) chunk.map((i) => process.stdout.write(getChar(i)));
})()